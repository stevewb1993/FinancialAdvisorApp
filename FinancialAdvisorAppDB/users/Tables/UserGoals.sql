...
(
	[UserGoalId] INT IDENTITY (1, 1) NOT NULL PRIMARY KEY,
	...
	CONSTRAINT [FK_UserGoals_FinancialTypes_FinanceTypeId] FOREIGN KEY ([FinanceTypeId]) REFERENCES [ref].[FinanceTypes] ([FinanceTypeId]) ON DELETE CASCADE
)
